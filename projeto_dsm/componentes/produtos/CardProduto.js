...
export default function CardProduto({ item, onExcluir, navigation }) {
  const excluir = async () => {
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.botoes}>
        <TouchableOpacity style={styles.btnEditar} onPress={() => navigation.navigate('CadastroProduto', { item })}>
...
const styles = StyleSheet.create({
  ...
  preco: { fontSize: 15, fontWeight: 'bold', color: '#1a7a3e', marginTop: 4 },
